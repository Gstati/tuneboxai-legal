...
- **Privacy Policy** : `https://gstati.github.io/tuneboxai-legal/privacy.html`
- **Terms of Service** : `https://gstati.github.io/tuneboxai-legal/terms.html`
- Landing : `https://gstati.github.io/tuneboxai-legal/`
...
git branch -M main
git remote add origin https://github.com/gstati/tuneboxai-legal.git
...
5. Attends 1-2 min, GitHub te donne l'URL : `https://gstati.github.io/tuneboxai-legal/`

## Étape 4 — Vérifier

Ouvre les 3 URLs dans ton navigateur :
- https://gstati.github.io/tuneboxai-legal/
- https://gstati.github.io/tuneboxai-legal/privacy.html
- https://gstati.github.io/tuneboxai-legal/terms.html
...
- Côté DNS : ajouter un CNAME `legal` → `gstati.github.io`
